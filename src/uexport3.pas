...
{$I MyLCL_Graphic.inc}  //BASECLASS:TObject
{$I MyLCL_PngImage.inc}  //BASECLASS:TObject
{$I MyLCL_JPEGImage.inc}  //BASECLASS:TObject
{$I MyLCL_GIFImage.inc}  //BASECLASS:TObject
